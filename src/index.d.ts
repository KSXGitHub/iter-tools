...
type BatchReturnElement<N extends ReasonableNumber, Iter extends Iterable<any>> =
  N extends 0
    ? Iter extends any[] ? Iter :
      Iter extends Iterable<infer T> ? T[] :
      never
...
export declare function batch<N extends ReasonableNumber>(n: N):
  <Iter extends Iterable<any>>(iterable: Iter) => IterableIterator<BatchReturnElement<N, Iter>>;
export declare function batch<N extends ReasonableNumber, Iter extends Iterable<T>>(
  n: N,
  iterable: Iter
...
export declare function asyncBatch<N extends ReasonableNumber>(n: N):
  <Iter extends Iterable<any>>(iterable: Iter) => AsyncIterableIterator<BatchReturnElement<N, Iter>>;
